...
\begin{itemize}
  ...
  component with no path to vertices outside that component.
\end{itemize}
...
Then this can be converted back to continuous time by multiplying with the time
...
library \cite{matplotlib}, the NumPy library \cite{numpy}.
