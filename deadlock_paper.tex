...
To illustrate this concept Figure~\ref{exampledigraphs} show examples of queueing network in and out of deadlock, and the corresponding state digraph in each case.
...
Now the actual effective service rate $\widetilde{\mu}_1$ for $\widetilde{\Omega}_{1_1}$ must lie in the interval $(\mu_1, m_1)$. Using Lemma~\ref{lem:oneminima} and Remark~\ref{rem:findmaximum}, we can conclude that $\widetilde{\omega}_{1_1} \leq \max(\omega_{1_1}^{\star}, \omega_{1_1}^{\star\star})$ when all other parameters are fixed.

Consider the effective arrival rate of $\widetilde{\Omega}_{1_1}$.
