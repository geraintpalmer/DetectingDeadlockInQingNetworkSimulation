...
whereby some customers may be unable to ever leave a server due to {\color{red}mutual
blocking.}
This paper explores deadlock in {\color{red}queueing networks with limited queueing
capacity}, presents a method of detecting deadlock in {\color{red}discrete event
...
Finally, an upper bound on the {\color{red}expected} time to deadlock of the two node
...
\textcolor{red}{Deadlock is caused by blocking.
...
\begin{definition}
    {\color{red}When there is a subset of blocked customers who are blocked directly or
    indirectly by customers in that subset only, then the system is said
    to be in deadlock.}
\end{definition}

\textcolor{red}{This implies that a system is in deadlock when at least one service station
...
\textcolor{red}{First in first out, or FIFO service discipline is also assumed.}
...
{\color{red}A survey of avoidance techniques for automated guided vehicle systems is given
in \cite{vis06}.}
These techniques generally determine when resources cannot be allocated as
that allocation would lead to deadlock.
{\color{red}In \cite{florianetal08} a priority based deadlock avoidance algorithm is
...
{\color{red}given that each node $j$ has total capacity $B_j$,} for each minimum cycle $C$,
...
{\color{red}In \cite{schmidtjackman00} a deadlock prevention/avoidance mechanism for open
...
{\color{red}A number of deadlock types are defined in \cite{venkateshetal98}, and their
...
{\color{red}In previous literature on wait-for graphs these are bespoke graphs that
...
The next section builds Markov models of three queueing networks, and discusses
their deadlocking properties.


\section{Markovian Models of Deadlocking Queueing Networks}\label{sec:markovmodels}

The following {\color{red}three} networks describe all possible configurations of 
...
It can be seen that increasing the arrival rate $\Lambda$ and the {\color{red}routing}
...
minimum (from Remark~\ref{rem:oneminima}), and so {\color{red}
...
$c_2 = 2$ were used.
{\color{red}Only plots for the parameter corresponding to Node 1 are shown, Node 2 shows
similar behaviour.}
...
The state space is given by:
    {\color{red}\[S = \{(i,j)\in\mathbb{N}^{(n_1+2)\times (n_2+2)} \nonscript\; | \nonscript\; 0 \leq i + j \leq n_1 + n_2 + 2
    \}\cup\{(-1), (-2), (-3)\}\]}
...
system.
{\color{red}After the bound is given, considerations on its tightness are given.}
...
\begin{center}
\resizebox{\textwidth}{!}{
\begin{tabular}{rrrrrrrrrr|rr|rrrrr|rr}
\toprule
...
\midrule
1.5 & 0.7 & 1.0 & 2.5 & 2 & 3 & 0.2 & 0.6 & 0.6 & 0.2 & 0.297 & 0.158 & 22.185 & 12.748 & 45.067 & 278.568 & 20.564 & 20.564 & 5.859\\
0.9 & 0.4 & 1.0 & 1.5 & 3 & 4 & 0.4 & 0.2 & 0.4 & 0.6 & 0.225 & 0.171 & 18.069 & 14.495 & 26.195 & 96.996 & 1673.394 & 18.069 & 8.099\\
0.7 & 0.8 & 1.0 & 1.0 & 0 & 1 & 0.6 & 0.4 & 0.8 & 0.2 & 0.166 & 0.166 & 12.380 & 4.047 & 38.541 & 18.750 & 11.353 & 11.353 & 2.492\\
0.8 & 0.6 & 1.0 & 2.5 & 3 & 4 & 0.2 & 0.2 & 0.2 & 0.4 & 0.297 & 0.158 & 30.233 & 37.500 & 28.253 & 335.531 & 3560.310 & 37.500 & 18.751\\
0.2 & 1.0 & 1.0 & 0.5 & 3 & 3 & 0.2 & 0.2 & 0.2 & 0.4 & 0.083 & 0.133 & 115.925 & 2265.000 & 24.633 & 12.232 & 2128.407 & 24.633 & 11.327\\
1.3 & 1.6 & 1.0 & 1.0 & 5 & 3 & 0.2 & 0.2 & 0.2 & 0.6 & 0.166 & 0.166 & 38.473 & 21.539 & 13.015 & 5.276 & 60.563 & 13.015 & 4.583\\
0.4 & 0.9 & 1.0 & 2.0 & 0 & 5 & 0.4 & 0.2 & 0.4 & 0.2 & 0.266 & 0.166 & 15.625 & 8.750 & 42.816 & 268.428 & 200.039 & 15.625 & 5.015\\
1.9 & 0.7 & 1.0 & 2.5 & 5 & 0 & 0.6 & 0.2 & 0.2 & 0.2 & 0.297 & 0.158 & 9.305 & 5.933 & 38.642 & 9.142 & 62.223 & 9.305 & 3.767\\
1.1 & 2.0 & 1.0 & 0.5 & 4 & 5 & 0.2 & 0.4 & 0.4 & 0.6 & 0.083 & 0.133 & 68.647 & 25.206 & 15.910 & 6.975 & 19.703 & 15.910 & 5.546\\
0.7 & 1.6 & 1.0 & 2.0 & 0 & 0 & 0.2 & 0.6 & 0.4 & 0.4 & 0.266 & 0.166 & 25.892 & 12.142 & 16.562 & 2.812 & 8.218 & 8.218 & 1.887\\
\bottomrule
\end{tabular}
}
\end{center}
...
{\color{red}Blocking of Type II and III should also be considered, both in the analytical
