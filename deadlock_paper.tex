...
Although \cite{holt72} lists the three strategies as prevention, detection and crashing, which is equavalent to having no deadlock strategy.
...
For simulation modelling however, prevention and avoidance techniques may not be appropriate as they can potentially inhibit realism in the simulation by taking actions that do not occur in system being modelled \cite{venkateshetal98}.
...
Though time to resolve deadlock may not be negligible in reality.
