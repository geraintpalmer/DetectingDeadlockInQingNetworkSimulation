...
(\cite{Citation about reproducible research}).  The code for the simulation can
be found here: \url{https://github.com/geraintpalmer/QNetSim} with documentation
available here: \url{docs}.
...
to implement Theorem~\ref{the:}. More efficient algorithms could be used for
