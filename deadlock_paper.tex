...
Transient deadlock here is equivalent to blocking in this paper, and isn't considered a deadlock situation here; whereas permanent deadlock is equivalent to the deadlock that is discussed in this paper. Figure~\ref{fig:deadlocktypes} illustrates these differences.
