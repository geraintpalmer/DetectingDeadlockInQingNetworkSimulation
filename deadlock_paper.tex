...
The simulation model used to run a discrete event simulation of the open restricted queueing network, detect deadlock and stop the simulation at this point. The time the simulation ran for until deadlock is recorded.
...
In this section markov models are build for the following deadlocking queueing networks
...
Any deadlocked states cannot transition to any other state, and so is an absorbing state of the Markov chain.
...
\subsection{One Node Single Server}
...
\subsection{Two Node Single Server without Self-Loops}
...
\subsection{Two Node Single Server with Self-Loops}
