...
\begin{figure}[!htbp]
  ...
  \end{center}
  \caption{Illustrating the types of deadlock, and the differences between the meaning of deadlock in this paper (top) and in some of the literature (bottom). Adapted from \cite{venkateshetal98}. States considered as deadlock are italicised.}
