...
\begin{definition}
    ...
    indirectly by customers in that subset only only, then the system is said
    to be in deadlock.
\end{definition}
...
First in first out, or FIFO service discipline is assumed.
...
This causes problems for the patient as they are being cared for in an
...
out easily''.
Further, in \cite{koizumietal05} a health and community care system is
described as having restricted feedback loops.
...
These emphasise the discrepancies that occur between common modelling
...
$c_2 = 2$ were used.
Only plots for changing parameter of Node 1 are shown, Node 2 shows similar
behaviour.
