...
Table~\ref{tab:applybound} shows a few examples of this bound on some parameter sets
This bound has been tested for over 7 million parameter sets.
A sample of the data can be found here \url{http://www.geraintianpalmer.org.uk/assets}.
...
\end{center}
\caption{Table of example parameter sets illustrating the bound of Theorem~\ref{thrm:bound}.}
