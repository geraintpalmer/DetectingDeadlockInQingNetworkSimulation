...
Finally a bound on the expected time to deadlock for one of these models was given, that was found to be tighter for those networks that eith high probability of reaching deadlocked state (-3).
