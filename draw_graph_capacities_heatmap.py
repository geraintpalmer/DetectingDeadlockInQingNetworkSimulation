...
plt.pcolor(X, Y, masked_data, cmap='viridis_r', linewidth=1, linestyle='solid', edgecolor='black')
...
plt.xlabel(r'$n_2$')
plt.ylabel(r'$n_1$')
plt.title('Times to Deadlock - Varying ' + r'$n_1$' + ' and ' + r'$n_2$', fontsize=18)
plt.savefig('images/n1n2_heatmap.pdf')
plt.show()