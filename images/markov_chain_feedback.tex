...
\begin{tikzpicture}
    ...
    \draw[rounded corners=10mm,fill=magenta!10, draw=none] (-0.75, -9.75) rectangle (6.75, -5.25);
    \draw[rounded corners=10mm,fill=violet!10, draw=none] (8.25, -3.75) rectangle (12.75, 0.75);
