...
\begin{tikzpicture}
    ...
    \draw[draw=green!60!black] (n+c) edge[out=135,in=45,->,thick] node [above,text=green!60!black] {\tiny$cr_{11}\mu$} (n+c+1);
    \draw[draw=green!60!black] (n+c+1) edge[out=135,in=0,->,thick] node [above,text=green!60!black] {\tiny$(c-1)r_{11}\mu$} ($(n+c+1)+(-1.5,0.7)$);
    ...
    \draw[draw=blue] (n+2c-1) edge[out=-35,in=-105,->,thick] node [above, text=blue] {\tiny$(1-r_{11})\mu$} (n+c-1);
