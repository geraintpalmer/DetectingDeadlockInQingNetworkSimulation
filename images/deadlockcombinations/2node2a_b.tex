...
\begin{tikzpicture}
  ...
  \node (b) [style={minimum size=1.5cm,fill=green,text=black,shape=circle}] at (2.5, 2.5) {\LARGE{b}};
  ...
  \draw[draw=green, ultra thick, -triangle 90] (b) to [out=-300,in=0,looseness=4] (b);
