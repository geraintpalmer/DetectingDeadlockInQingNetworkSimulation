...
\begin{tikzpicture}
  \draw[opacity=.3,line width=25mm,line cap=round,draw=yellow, rounded corners=2.5mm] (0, 0) -- (0, 0);
  \draw[opacity=.3,line width=25mm,line cap=round,draw=yellow, rounded corners=2.5mm] (3, 0) -- (3, 0);
  \draw[opacity=.3,line width=25mm,line cap=round,draw=yellow, rounded corners=2.5mm] (0, 3) -- (3, 3);
