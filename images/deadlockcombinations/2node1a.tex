...
\begin{tikzpicture}
  ...
  \node (b) [style={minimum size=1.5cm,fill=black!20!white,text=black,shape=circle}] at (2.5, 2.5) {\LARGE{b}};
  ...
  \draw[draw=black!20!white, ultra thick, -triangle 90] (b) to [out=-300,in=0,looseness=4] (b);
