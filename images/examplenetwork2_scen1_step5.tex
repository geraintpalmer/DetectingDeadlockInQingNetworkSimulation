...
\begin{tikzpicture}
  ...
  \draw[fill=black!30] (9.25, 2.5) circle (1) node {\large{$(A_1, 5, B)$}}; % Servcie top A
  \draw[fill=black!30] (9.25, 0) circle (1) node {\large{$(A_2, 6, A)$}}; % Service bottom A
  \draw (17.25, 1.25) circle (1) node {\large{$(\emptyset, 7, \emptyset)$}}; % Back of B
  \draw (19.75, 1.25) circle (1) node {\large{$(\emptyset, 8, \emptyset)$}}; % Middle of B
  \draw (22.25, 1.25) circle (1) node {\large{$(\emptyset, 9, \emptyset)$}}; % Front of B
  \draw[fill=black!30] (25.25, 1.25) circle (1) node {\large{$(B_1, 10, A)$}}; % Service B
  ...
  \draw[fill=black!30] (11.25, 8) circle (1) node {\large{$(B_2, 14, A)$}}; % Service bottom C
  \draw (11.25, 10.5) circle (1) node {\large{$(B_1, 15, \emptyset)$}}; % Service top C
