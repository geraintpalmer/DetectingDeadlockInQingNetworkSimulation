...
\begin{tikzpicture}
  ...
  \node (B1) [style={minimum size=1.5cm,draw=black,fill=black!30!white,text=black,shape=circle}] at (1.545, 4.755) {$B_1$};
  \node (B2) [style={minimum size=1.5cm,draw=black,fill=black!30!white,text=black,shape=circle}] at (-4.045, 2.939) {$B_2$};
