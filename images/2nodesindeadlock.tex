...
\node[align=center] [style={minimum size=1.4cm, text width=1.0cm, draw=black,fill=black!25,text=black,shape=circle}] at (3.9, 9) {\LARGE $B_1$};
\draw[ultra thick, black, dashed, ->] (3.2, 9) [bend left=45] to (3.5, 14.4);

\node[align=center] [style={minimum size=1.4cm, text width=1.0cm, draw=black,fill=black!25,text=black,shape=circle}] at (10.2, 15) {\LARGE $A_1$};
