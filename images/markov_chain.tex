...
\begin{tikzpicture}
    ...
    \draw (30) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(21)+(-0.5,-0.2)$);
    \draw (20) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(11)+(-0.5,-0.2)$);
    \draw (10) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(01)+(-0.5,-0.2)$);

    \draw (31) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(22)+(-0.5,-0.2)$);
    \draw (21) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(12)+(-0.5,-0.2)$);
    \draw (11) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(02)+(-0.5,-0.2)$);

    \draw (22) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(13)+(-0.5,-0.2)$);
    \draw (12) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(03)+(-0.5,-0.2)$);

    \draw (13) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(04)+(-0.5,-0.2)$);
    \draw (32) edge[out=90,in=180,->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(23)+(-0.5,-0.2)$);
    ...
    \draw ($(22)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{21}\mu_2$} ($(31)+(0.1,0.3)$);
    \draw ($(12)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{21}\mu_2$} ($(21)+(0.1,0.3)$);
    \draw ($(02)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{21}\mu_2$} ($(11)+(0.1,0.3)$);

    \draw ($(13)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{21}\mu_2$} ($(22)+(0.1,0.3)$);
    \draw ($(03)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{21}\mu_2$} ($(12)+(0.1,0.3)$);

    \draw ($(04)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{21}\mu_2$} ($(13)+(0.1,0.3)$);
    \draw ($(14)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{21}\mu_2$} ($(23)+(0.1,0.3)$);
