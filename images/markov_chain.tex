...
\begin{tikzpicture}
    ...
    \draw[blue] (00) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (10);
    \draw[blue] (01) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (11);
    \draw[blue] (02) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (12);
    \draw[blue] (03) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (13);

    \draw[blue] (10) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (20);
    \draw[blue] (11) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (21);
    \draw[blue] (12) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (22);
    \draw[blue] (13) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (23);

    \draw[blue] (20) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (30);
    \draw[blue] (21) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (31);
    \draw[blue] (22) edge[<-,thick] node [left] {\tiny$(1-r_{12})\mu_1$} (32);

    % Second station service and exit
    \draw[draw=cyan] (04) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (03);
    \draw[draw=cyan] (03) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (02);
    \draw[draw=cyan] (02) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (01);
    \draw[draw=cyan] (01) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (00);

    \draw[draw=cyan] (14) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (13);
    \draw[draw=cyan] (13) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (12);
    \draw[draw=cyan] (12) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (11);
    \draw[draw=cyan] (11) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (10);

    \draw[draw=cyan] (23) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (22);
    \draw[draw=cyan] (22) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (21);
    \draw[draw=cyan] (21) edge[->,thick] node [above, text=cyan] {\tiny$(1-r_{21})\mu_2$} (20);
