...
% State digraph Nodes
\node (A1) [style={minimum size=2.5cm,draw=black,fill=black!3,text=black,shape=circle}] at (27.5, 10) {\huge{$A_1$}};
\node (B1) [style={minimum size=2.5cm,draw=black,fill=black!3,text=black,shape=circle}] at (24.045, 14.755) {\huge{$B_1$}};
\node (B2) [style={minimum size=2.5cm,draw=black,fill=black!3,text=black,shape=circle}] at (18.455, 12.939) {\huge{$B_2$}};
\node (C1) [style={minimum size=2.5cm,draw=black,fill=black!3,text=black,shape=circle}] at (18.455, 7.061) {\huge{$C_1$}};
\node (C2) [style={minimum size=2.5cm,draw=black,fill=black!3,text=black,shape=circle}] at (24.045, 5.245) {\huge{$C_2$}};
...
\draw[ultra thick, black, dashed, ->] (3.2, 8.1) [bend left=45] to (3.3, 14.6);
