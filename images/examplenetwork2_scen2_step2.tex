...
\begin{tikzpicture}
  ...
  %\draw[fill=black!30] (25.25, 1.25) circle (1) node {\large{$(B_1, 6, C)$}}; % Service B
  ...
  \draw (11.25, 8) circle (1) node {\large{$(C_2, 6, \emptyset)$}}; % Service bottom C
  \draw[fill=black!30] (11.25, 10.5) circle (1) node {\large{$(C_1, 7, A)$}}; % Service top C
