...
Then customer 9 finishes service and is blocked from entering node $A$. Figure~\ref{general_buildup_4}.
...
For illustrative purposes the queueing network here is a different queueing network than in Figure~\ref{fig:general_buildup_1}.
...
Assume that we have labelled the edges of the digraph iteratively, that is the 1st edges drawn are weighted 1, 2nd edges drawn are weighted 2 etc. % If this works then I'll include this in the write up of how state digraph is formed
