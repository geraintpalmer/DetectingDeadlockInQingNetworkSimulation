...
When an individual is released and another customer who was previously blocked occupies their server, that servers out-edges are removed along with the in-edge from the server who occupied that previously blocked customer.
