...
This effect is seems to only begin as the probability increases above $p_{(-3)} \approx 1.75$.
Queueing networks with absorption probability $p_{(-3)} \leq 1.75$ are either unaffected by this effect, or there are more complicated effects occuring simultaneously to obscure this effect.
