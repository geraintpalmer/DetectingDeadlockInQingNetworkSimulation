...
\begin{proof}
  ...
  As there is a route from every node to every other node, this corresponds to every possible compination of nodes.
  ...
  At first glance a Bell number seems inappropriate as this problem isn't looking for every possible partition, but every possible combination of nodes, even if that is inexhaustive of the set of nodes.
  What we need to find is every possible partition of every set in $\mathcal{P}(S) \setminus \emptyset$.
