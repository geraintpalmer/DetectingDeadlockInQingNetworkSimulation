...
The thesis investigates two and three node systems, as well as systems with one service centre with infinite queue routing into a number of these two and three node systems.
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \caption{Comparing time to deadlock and absorbtion probabilities as queue capacities increase.}
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \end{center}
  \caption{The effect of varying parameters on times to deadlock.}
...
\begin{proof}
  ...
  Similarly an unblocking where a customer transitions from being blocked at Node 2 to being at Node 1 yields $\delta = (0, -1)$; his blocked part at $i$ disappears, while his existence part at $j$ transitions to Node 2 to become a $i$.
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \begin{subfigure}[b]{0.333\textwidth}
    \includegraphics[width=\textwidth]{images/dummygraph}
    \caption{Varying $r_{12}$}
    \label{fig:2Nms_r12}
  \end{subfigure}
  \begin{subfigure}[b]{0.333\textwidth}
